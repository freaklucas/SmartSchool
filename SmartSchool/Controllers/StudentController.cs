...
public class StudentController : ControllerBase
{
    ...
    public IActionResult PostStudent(StudentRegisterDTO model)
    {
        ...
        _repo.Add(student);
        if (_repo.SaveChanges()) return Created($"/api/student/{model.Id}", _mapper.Map<StudentDTO>(student));
    ...
    public IActionResult PutStudent(int id, StudentRegisterDTO model)
    {
        ...
        if (_repo.SaveChanges()) return Created($"/api/student/{model.Id}", _mapper.Map<StudentDTO>(studentExists));
